...
(Your table might be missing the RL number by default). For a lot more information around the speedrun script and what to look for and expect, please refer to the walkthrough that I posted in Discussions of the repo: ["Introducing vibechat: The best ChatGPT that $100 can buy"](https://github.com/ttracx/vibechat/discussions/1).
...
And a bit more about computing environments that will run vibechat:
...
@misc{vibechat,
  ...
  title = {vibechat: The best ChatGPT that $100 can buy},
  year = {2025},
  publisher = {GitHub},
