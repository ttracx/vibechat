...
def generate_header():
    ...
    header = f"""# vibechat training report
...
# -----------------------------------------------------------------------------
# vibechat-specific convenience functions
...
def get_report():
    ...
    from vibechat.common import get_base_dir, get_dist_info
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="Generate or reset vibechat training reports.")
