...
from vibechat.common import compute_init, compute_cleanup, get_base_dir, print0, DummyWandb
...
wandb_run = DummyWandb() if use_dummy_wandb else wandb.init(project="vibechat-sft", name=run, config=user_config, save_code=True)
